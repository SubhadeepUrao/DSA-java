...
class Twitter {
    ...
    public void follow(int followerId, int followeeId) {
        if(mpp[followerId] == null) {
            mpp[followerId] = new HashSet<>(Collections.singleton(followeeId));
        }
        else {
            mpp[followerId].add(followeeId);
        }
    }
    
    public void unfollow(int followerId, int followeeId) {
        if(mpp[followerId] != null) {
            mpp[followerId].remove(followeeId);
        }
    }
}